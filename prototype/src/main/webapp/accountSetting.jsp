...
<head>
    ...
    <form action="updateProfile.jsp" method="post">
        ...
        <label>FIRST NAME:</label>
        <input type="text" class="input-field" name="firstName" placeholder="FIRST NAME" value="<%=request.getParameter("firstName") %>" required>
        <label>LAST NAME:</label>
        <input type="text" class="input-field" name="lastName" placeholder="LAST NAME" value="<%=request.getParameter("lastName") %>" required>
        <label>PHONE:</label>
        <input type="tel" class="input-field" name="phone" placeholder="PHONE" value="<%=request.getParameter("phone") %>" required>
        <label>STREET ADDRESS:</label>
